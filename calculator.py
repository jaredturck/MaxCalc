        ...
        while True:
            try:
                ...
                if m := re.match(r'^\s*help\s*$', inp):
                    ...
                    if len(self.ui.text["display"]) > 0: self.ui.addText("display")
                    ...
                    else: self.ui.addText("display", ("Usage: ", ), ("debug [on/off]", UI.LIGHTBLUE_ON_BLACK))
                    ...
                    else: self.ui.addText("display", ("Usage: ", ), ("keyboard [on/off] (allows use of keyboard module)", UI.LIGHTBLUE_ON_BLACK))
                    ...
                    else: self.ui.addText("display", ("Usage: ", ), ("quick_exp[onents] [on/off]", UI.LIGHTBLUE_ON_BLACK))
